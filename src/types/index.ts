...
export interface Invite { // Corresponds to 'invites' collection
  ...
  formId: string; // ID of the form this invite pertains to
  role: Exclude<UserRole, "Owner">; // Role to be assigned upon acceptance for this specific form (cannot invite as Owner)
  status: InviteStatus;
...
export interface QuestionSchema { // Represents a field within a survey's 'fields' array
  ...
  surveyId: string; // ID of the survey this question belongs to (useful if denormalized or for subcollections)
...
export interface FormResponse { // Corresponds to 'responses' collection
  ...
  surveyId: string; // Corrected from formId to surveyId for consistency with QuestionSchema
